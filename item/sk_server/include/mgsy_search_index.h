#ifndef __mgsy_SEARCH_INDEX_H__
#define __mgsy_SEARCH_INDEX_H__

#include "sk_def.h"
#include "common_util.h"

class mgsy_search_index:public base_search_index, public ToBufferMgr<std::multimap<float, std::string> >
{
    public:
        virtual ~mgsy_search_index(){}
