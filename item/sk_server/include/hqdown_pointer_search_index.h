#ifndef __hqdown_pointer_SEARCH_INDEX_H__
#define __hqdown_pointer_SEARCH_INDEX_H__

#include "sk_def.h"
#include "common_util.h"

class hqdown_pointer_search_index:public base_search_index, public ToBufferMgr<std::map<std::string, std::multimap<float, std::string> > >
{
    public:
        virtual ~hqdown_pointer_search_index(){}
