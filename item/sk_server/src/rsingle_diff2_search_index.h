#ifndef __rsingle_diff2_SEARCH_INDEX_H__
#define __rsingle_diff2_SEARCH_INDEX_H__

#include "sk_def.h"
#include "common_util.h"

class rsingle_diff2_search_index:public base_search_index, public ToBufferMgr<std::vector<std::multimap<int, std::string> > >
{
    public:
        virtual ~rsingle_diff2_search_index(){}
