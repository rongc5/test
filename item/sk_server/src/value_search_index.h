#ifndef __value_SEARCH_INDEX_H__
#define __value_SEARCH_INDEX_H__

#include "sk_def.h"
#include "common_util.h"

class value_search_index:public base_search_index, public ToBufferMgr<std::multimap<int, std::string> >
{
    public:
        virtual ~value_search_index(){}
