...
{
   if (!key.compare("hqrange_percent_ge") || !key.compare("hqrange_percent_ge_v"))
   {
       return do_check_hqrange_percent_ge(key, value, search);
   }
   else if (!key.compare("hqrange_percent_le") || !key.compare("hqrange_percent_le_v"))
   {
       return do_check_hqrange_percent_le(key, value, search);
   }
   else if (!key.compare("hqrange_percent_ge_num_ge") || !key.compare("hqrange_percent_ge_num_ge_v"))
   {
       return do_check_hqrange_percent_ge_num_ge(key, value, search);
   }

   return false;
}

bool hqrange_percent_search_index::do_check_hqrange_percent_le(std::string &key, std::string &value, std::set<std::string> & search)
{
    float end = 0;
...
bool hqrange_percent_search_index::do_check_hqrange_percent_ge(std::string &key, std::string &value, std::set<std::string> & search)
{
    float end = 0;
    std::multimap<float, std::string>::iterator it_le, it_ge, it;
...
bool hqrange_percent_search_index::do_check_hqrange_percent_ge_num_ge(std::string &key, std::string &value, std::set<std::string> & search)
{
    float end = 0;
    std::multimap<float, std::string>::iterator it_le, it_ge, it;
    std::map<std::string, std::multimap<float, std::string> >  * search_index = current();
