...
class plate_search_index:public base_search_index, public ToBufferMgr<std::unordered_multimap<std::shared_ptr<std::string>, std::string, str_hasher, str_equaler> > 
{
    public:
