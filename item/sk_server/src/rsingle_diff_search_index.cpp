...
bool rsingle_diff_search_index::do_check_rsingle_diff_le(std::string &key, std::string &value, std::set<std::string> & search)
{
    uint32_t index = 0;
    int end = 0;
    ...
    it_le = search_index->uprsingle_diffr_bound(end);
...
bool rsingle_diff_search_index::do_check_rsingle_diff_ge(std::string &key, std::string &value, std::set<std::string> & search)
{
    uint32_t index = 0;
    int end = 0;
    std::multimap<float, std::string>::iterator it_le, it_ge, it;
