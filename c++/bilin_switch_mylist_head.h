...
private:
    ...
    void __list_link(list_head<KEY, VALUE> *prev, list_head<KEY, VALUE> * next);
...
template<class KEY, class VALUE>
void switch_mylist_head<KEY, VALUE>::__list_link(list_head<KEY, VALUE> *prev, list_head<KEY, VALUE> * next)
{
	prev->next = next;
    	next->prev = prev;
}
...
{
    list_head<KEY, VALUE> * pos, *head, *tmp;
...
template<class KEY, class VALUE>
void switch_mylist_head<KEY, VALUE>::clear()
{
    list_head<KEY, VALUE> * head, *pos, *tmp;
    //CThreadLock lock(&m_mutex);
    head = &m_list_entry;
