/*
 * FileName:       
 * Author:         wangqifeng  Version: 1.0  Date: 2012-6-18
 * Description:    
 * Version:        
 * Function List:  
 *                 1.
 ...
 */
#ifndef __HTTP_BASE_PROCESS_HPP_
#define __HTTP_BASE_PROCESS_HPP_
#include <map>
#include <string>
#include <vector>
#include "framecommon/framecommon.h"
#include "framecommon/my_singleton.h"
#include "net_obj.h"

using namespace std;
using namespace MYFRAMECOMMON;

const uint32_t MAX_HTTP_HEAD_LEN = 10*1024;
enum HTTP_STATUS
{
    RECV_HEAD = 0,
    RECV_BODY = 1,
