#include "http_res_data_process.h"
#include "common_def.h"



http_res_data_process(tcp_connect * t_cn):http_data_process(t_cn)
{
...
http_res_data_process::~http_res_process()
{		
}

http_head_para &http_res_data_process::get_req_head_para()
{
    return _req_head_para;
}

http_res_head_para &http_res_data_process::get_res_head_para()
{
    return _res_head_para;
}

void http_res_data_process::set_res_head_para(const http_res_head_para &para)
{
    _res_head_para = para;
}

void http_res_data_process::reset()
{
...
string http_res_data_process::gen_res_head()
{
    stringstream ss;
    //返回状态码
...
size_t http_res_data_process::process_recv_body(char *buf, size_t len, int &result)
{
    int ret = 0;
...
void http_res_data_process::parse_header()
{
...
void http_res_data_process::send_finish()
{        	
...
size_t http_res_data_process::get_boundary(char *buf, size_t len, int &result)
{	
